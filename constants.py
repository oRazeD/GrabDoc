...
# insteads reads GD-specific attributes, or whatever alternative relies
...
class GlobalVariableConstants:
    ...
    UNRENDERABLE_TYPES = ('EMPTY', 'VOLUME', 'ARMATURE', 'LATTICE', 'LIGHT', 'LIGHT_PROBE', 'CAMERA')
...
directly to engine) by cramming greyscale baked maps into each RGBA channel of a single
...
\u2022 Only greyscale maps can currently be packed
...
"""
    ...
    PREVIEW_WARNING = """
Live Material Preview is a feature that allows you to pre-visualize your bake maps in real-time!

CONSIDER THIS WARNING: This feature is intended for previewing your materials, NOT for working
while inside a preview. Once finished, please exit previews to avoid potential scene altering changes.

Pressing `OK` will dismiss this warning permanently for this current project file.
"""
...
class ErrorCodeConstants:
    ...
    TRIM_CAM_NOT_FOUND = "Trim Camera not found, refresh the scene to set everything up properly"
    NO_OBJECTS_BAKE_GROUPS = "You have 'Use Bake Group' turned on, but no objects are inside the corresponding collection"
    NO_VALID_PATH_SET = "There is no export path set"

    MAT_SLOTS_WITHOUT_LINKS = "Material slots found without links & will be rendered using the sockets default value"

    MARMO_EXPORT_COMPLETE = "Export completed! Opening Marmoset Toolbag..."
    MARMO_RE_EXPORT_COMPLETE = "Models re-exported! Check Marmoset Toolbag"

    OFFLINE_RENDER_COMPLETE = "Offline render completed!"
